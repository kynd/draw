...
import { pressureAlong, pressureResponse } from '../../lib/demo/pressure.js';

const controls = {};
['base', 'scale', 'curve'].forEach(id => {
...
const cycle = setupDrawCycle({
    ...
    build: (path, points, seed) => {
        ...
        const def = new StrokeDef({
            ...
            widthLeft: t => base * (1 + (scale - 1) * pressureResponse(pressureAt(t), gamma)),
            renderer,
            seed,
        });
