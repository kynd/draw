    ...
    makeRow: (i, ctx) => {
        if (i === 0) {
            return new WashBlobRenderer({
                ...
                pigment: 0.35, feather: 0.1, rim: 0.5, flow: 0.03, wet: 0.85,
            });
        }
        if (i === 1) {
            return new WashBlobRenderer({
                color: ctx.color, background: ctx.blurred,
                pigment: 0.6, feather: 0.045, rim: 0.4, flow: 0.05, wet: 0.5,
            });
        }
        return new WashBlobRenderer({
            color: ctx.color, background: ctx.background,
            pigment: 0.97, feather: 0.012, rim: 0.15, flow: 0.09, wet: 0.12,
        });
    },
});
