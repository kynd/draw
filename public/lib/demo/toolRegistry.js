...
export const toolRegistry = [
    ...
    { id: 'tube-candy', kind: 'stroke', width: [4, 32],
    ...
    { id: 'tube-wobble', kind: 'stroke', width: [4, 32],
    ...
    { id: 'tube-metal', kind: 'stroke', width: [4, 32],
    ...
    { id: 'polygons', kind: 'stroke',
        params: [{ key: 'facet', min: 0.12, max: 0.6 }, { key: 'jitter', min: 0, max: 0.9 }],
        make: (v, ctx) => new PolygonStrokeRenderer({ facet: v.facet, jitter: v.jitter, colors: ctx.colors }) },
    ...
    { id: 'squares', kind: 'stroke', width: [5, 25],
    ...
    { id: 'spikes', kind: 'stroke', width: [5, 25],
