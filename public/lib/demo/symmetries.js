import { mirroredPath, rotatedPaths } from '../pathEffects.js';
 ...
 * the per-stroke roll (a rotation count, the screen axes, and at even odds
 * `recolors`, which gives every copy its own palette colors);
 * `symmetricCopies(path, roll, anchor)` returns the copies. The rolls use
