...
<li><a href="/draw/documentation/initializers"><strong>Initializers</strong></a> — compositions that fill a fresh canvas.<br /><span class="jp">まっさらなキャンバスを満たす構成。</span></li>
