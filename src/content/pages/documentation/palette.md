...
<div class="jp">`representativeL(H)`は、色相が名前どおりの絵の具に見える明度です。黄色は明るいときだけ黄色に見え、緑や青は、最大彩度の点よりずっと低い明度で名前どおりに見えます。色相の名前ごとの基準値（赤0.58、黄0.90、緑0.50、青0.45）を色相環に沿って補間します。</div>
